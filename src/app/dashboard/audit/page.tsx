...
export const metadata: Metadata = { title: 'Auditoria — Wave Listing' }
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="rounded-xl border border-dashed border-zinc-700 bg-zinc-900/50 p-16 text-center">
        ...
        <p className="text-zinc-400 text-sm">Módulo de auditoria em construção</p>
        <p className="text-zinc-600 text-xs mt-1">Em breve: scorecard completo, tabela de produtos e alertas</p>
      </div>
    </div>
  )
}
